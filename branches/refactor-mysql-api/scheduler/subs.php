...
if(isset($weekly)){
	echo '<div class="toggle"><a href="/scheduler/subs/daily">Daily</a> / <span class="toggled">Weekly</span></div>'."\n";
	echo '<div id="weekDiv">'."\n";
	...
	echo '<div class="toggle"><span class="toggled">Daily</span> / <a href="/scheduler/subs/weekly">Weekly</a></div>'."\n";
	echo '<div id="dayDiv">'."\n";
