...
if(file_exists('/home/teulberg/lpl-repository.com/scheduler2/future/'.$yesterday.'.pdf')){
	unlink('/home/teulberg/lpl-repository.com/scheduler2/future/'.$yesterday.'.pdf');
	}
...
$dompdf->render();
file_put_contents("/home/teulberg/lpl-repository.com/scheduler2/future/$oneweekfull.pdf", $dompdf->output());
...
/* Add New Future Schedule */
$local_file = "/home/teulberg/lpl-repository.com/scheduler2/future/$oneweekfull.pdf";
