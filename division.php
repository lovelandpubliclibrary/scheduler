...
if (isset($sched_id)){
	echo '<div class="mobile toggle"><a href="/scheduler2/'.$division.'/daily">Daily</a> / <a href="/scheduler2/'.$division.'/weekly">Weekly</a></div>'."\n";
	...
	if(isset($weekly)){
		echo '<div class="toggle"><a href="/scheduler2/'.$division.'/daily">Daily</a> / <span class="toggled">Weekly</span></div>'."\n";
		echo '<div id="weekDiv">'."\n";
		...
		echo '<div class="toggle"><span class="toggled">Daily</span> / <a href="/scheduler2/'.$division.'/weekly">Weekly</a></div>'."\n";
		echo '<div id="dayDiv">'."\n";
